...
static quickcpp::signal_guard::signal_guard_install
...
int blake3_hasher_update_mmap(blake3_hasher *self, char const *path) noexcept {
  bool use_tbb = false;
  return blake3_hasher_update_mmap_base(self, path, use_tbb);
}

#if defined(BLAKE3_USE_TBB)
int blake3_hasher_update_mmap_tbb(blake3_hasher *self,
